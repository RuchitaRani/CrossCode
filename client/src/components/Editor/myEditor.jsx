...
const MyEditor = (props, userData) => {
  ...
  const copyRoomCode = () => {
    ...
    enqueueSnackbar(
      `Room-code copied! Share this code with your friends and Code with them!🤩`,
      {
        variant: "success",
      }
    );
  ...
  const downloadCode = (e) => {
    ...
    fileDownload(
      editorCode,
      `${title}.${languageExtension[fileExtensionValue]}`
    );
  };
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto">
              ...
              {/* <li className="nav-item">
                ...
                {/* <select name="allusers" id="cars">
                  {allUsers.map((i) => {
                    return <option disabled>{i.userName}</option>;
                  })}
                </select>
              </li> */}
